...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: zOFAy3URl6dh/css

import SquareSvgIcon from "./icons/PlasmicIcon__SquareSvg"; // plasmic-import: kHC6JjEKItgq/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: HBH-sxKQRcQ5/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: h4ZeXCtMAZ5u/icon
