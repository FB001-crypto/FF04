...
import sty from "./PlasmicChannelOptions__Overlay.module.css"; // plasmic-import: xj7ese5CU-H1/css

import SUPER__PlasmicChannelOptions from "./PlasmicChannelOptions"; // plasmic-import: Xh7VDAcPkzp8/render

createPlasmicElementProxy;

export type PlasmicChannelOptions__Overlay__VariantMembers = {
  relativePlacement: "top" | "bottom" | "left" | "right";
};
export type PlasmicChannelOptions__Overlay__VariantsArgs = {
  relativePlacement?: SingleChoiceArg<"top" | "bottom" | "left" | "right">;
};
type VariantPropType = keyof PlasmicChannelOptions__Overlay__VariantsArgs;
export const PlasmicChannelOptions__Overlay__VariantProps =
  new Array<VariantPropType>("relativePlacement");

export type PlasmicChannelOptions__Overlay__ArgsType = {
  children?: React.ReactNode;
};
type ArgPropType = keyof PlasmicChannelOptions__Overlay__ArgsType;
export const PlasmicChannelOptions__Overlay__ArgProps = new Array<ArgPropType>(
  "children"
);

export type PlasmicChannelOptions__Overlay__OverridesType = {
  root?: Flex__<"div">;
  top?: Flex__<"div">;
  middle?: Flex__<"div">;
  left?: Flex__<"div">;
...
export interface DefaultChannelOptions__OverlayProps
...
function PlasmicChannelOptions__Overlay__RenderFunc(props: {
  variants: PlasmicChannelOptions__Overlay__VariantsArgs;
  args: PlasmicChannelOptions__Overlay__ArgsType;
  overrides: PlasmicChannelOptions__Overlay__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicChannelOptions__Overlay__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicChannelOptions__Overlay__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicChannelOptions__Overlay__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicChannelOptions__Overlay__ArgProps,
          internalVariantPropNames: PlasmicChannelOptions__Overlay__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicChannelOptions__Overlay__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicChannelOptions__Overlay";
  } else {
    func.displayName = `PlasmicChannelOptions__Overlay.${nodeName}`;
  }
  return func;
}

export const PlasmicChannelOptions__Overlay = Object.assign(
  // Top-level PlasmicChannelOptions__Overlay renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicChannelOptions__Overlay
    internalVariantProps: PlasmicChannelOptions__Overlay__VariantProps,
    internalArgProps: PlasmicChannelOptions__Overlay__ArgProps,

    useBehavior
  }
);

export default PlasmicChannelOptions__Overlay;
/* prettier-ignore-end */
