...
import sty from "./PlasmicSaveAccountInfo.module.css"; // plasmic-import: CnVe_01iYRQK/css
...
export type PlasmicSaveAccountInfo__VariantMembers = {
...
export type PlasmicSaveAccountInfo__VariantsArgs = {
...
type VariantPropType = keyof PlasmicSaveAccountInfo__VariantsArgs;
export const PlasmicSaveAccountInfo__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicSaveAccountInfo__ArgsType = {
...
type ArgPropType = keyof PlasmicSaveAccountInfo__ArgsType;
export const PlasmicSaveAccountInfo__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicSaveAccountInfo__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultSaveAccountInfoProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicSaveAccountInfo__RenderFunc(props: {
  variants: PlasmicSaveAccountInfo__VariantsArgs;
  args: PlasmicSaveAccountInfo__ArgsType;
  overrides: PlasmicSaveAccountInfo__OverridesType;
  forNode?: string;
}) {
      ...
      {(
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___0MPwI)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__xaU)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicSaveAccountInfo>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSaveAccountInfo__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicSaveAccountInfo__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicSaveAccountInfo__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSaveAccountInfo__ArgProps,
          internalVariantPropNames: PlasmicSaveAccountInfo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSaveAccountInfo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSaveAccountInfo";
  } else {
    func.displayName = `PlasmicSaveAccountInfo.${nodeName}`;
  }
  return func;
}

export const PlasmicSaveAccountInfo = Object.assign(
  // Top-level PlasmicSaveAccountInfo renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSaveAccountInfo
    internalVariantProps: PlasmicSaveAccountInfo__VariantProps,
    internalArgProps: PlasmicSaveAccountInfo__ArgProps,

    useBehavior
  }
);

export default PlasmicSaveAccountInfo;
/* prettier-ignore-end */
