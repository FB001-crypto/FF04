...
export type PlasmicEarnOrLoss__VariantMembers = {
  status: "win" | "loss";
};
export type PlasmicEarnOrLoss__VariantsArgs = {
  status?: MultiChoiceArg<"win" | "loss">;
};
type VariantPropType = keyof PlasmicEarnOrLoss__VariantsArgs;
export const PlasmicEarnOrLoss__VariantProps = new Array<VariantPropType>(
  "status"
);

export type PlasmicEarnOrLoss__ArgsType = {};
type ArgPropType = keyof PlasmicEarnOrLoss__ArgsType;
export const PlasmicEarnOrLoss__ArgProps = new Array<ArgPropType>();

export type PlasmicEarnOrLoss__OverridesType = {
  group44098?: Flex__<"div">;
  text?: Flex__<"div">;
  group?: Flex__<"div">;
  img?: Flex__<typeof PlasmicImg__>;
};

export interface DefaultEarnOrLossProps {
  status?: MultiChoiceArg<"win" | "loss">;
  className?: string;
}
...
function PlasmicEarnOrLoss__RenderFunc(props: {
  variants: PlasmicEarnOrLoss__VariantsArgs;
  args: PlasmicEarnOrLoss__ArgsType;
  overrides: PlasmicEarnOrLoss__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicEarnOrLoss__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicEarnOrLoss__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicEarnOrLoss__ArgsType,
      ReservedPropsType
    > &
